      ...
      <Card className="w-full max-w-2xl bg-white/80 backdrop-blur-sm border-gray-100 rounded-2xl shadow-card">
        ...
        <CardContent className="p-8">
          <div className="border-2 border-dashed border-gray-200 rounded-2xl p-16 text-center hover:border-brand/40 hover:bg-brand/5 transition-all duration-300 cursor-pointer bg-gray-50/30 backdrop-blur-sm group" onDrop={handleDrop} onDragOver={handleDragOver}>
            ...
            <Button asChild className="bg-brand hover:bg-brand-600 text-white rounded-xl px-8 py-3 font-medium shadow-sm hover:shadow-md transition-all duration-200 font-space-grotesk">
