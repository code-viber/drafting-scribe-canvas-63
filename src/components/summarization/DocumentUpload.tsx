        ...
        <Card className="w-full max-w-2xl bg-white/80 backdrop-blur-sm border-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent className="p-8 my-0 py-[5px]">
            ...
            >
              ...
              <Button 
                asChild 
                className="bg-brand hover:bg-brand-600 text-white rounded-xl px-8 py-3 font-medium shadow-sm hover:shadow-md transition-all duration-200 font-space-grotesk hover:scale-105"
              >
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-gray-100 rounded-2xl shadow-sm">
          ...
          <CardContent className="space-y-3">
            {recentUploads.map((upload) => (
              <div key={upload.id} className="flex items-center justify-between p-4 bg-gray-50/50 rounded-xl hover:bg-gray-50 transition-colors duration-200">
